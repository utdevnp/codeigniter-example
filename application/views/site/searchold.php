                    ...
                    <ul class="booking-list">
                    	...
                    	foreach($busschedule as $displybus){ 
                           ...
                           $busdetail =   $this->dynamic_query->getby($displybus['bus_no'],'bus_setup','id');
                            ...
                            <a class="booking-item" href="javascirpt:void(0)">
                                <div class="row">
                            ...
                            <div class="modal fade" data-keyboard="false" data-backdrop="static" id="busSeat<?php echo $displybus['id'];?>" role="dialog">
                            <div class="modal-dialog modal-lg">
                            <form method="post" id="seatselectForm" action="<?php echo base_url('home/travallers');?>">
                              <!-- Modal content-->
