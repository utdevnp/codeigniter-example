...
<body onload="window.close(1);">
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <tr>
              ...
              <td colspan="2">
                 <div class="col-sm-12 invoice-col">
                    ...
                    <b>Departing  : </b> <?php echo nice_date($buschedule['departure'],"M d, D")." ".$buschedule['departuretime'] ; ?><br>
                    <b>Boarding Point:</b> <?php foreach($passenger_info as $pinfo){foreach($allroutes as $route){if($route['id']==$pinfo['boarding']){echo $route['from'];}}}?> (<?php echo $btimes;?>)
					<br>
				<hr>
              ...
              <td colspan="2">
                <div class="col-sm-12 invoice-col">
                   ...
                   <b> Arrival :</b> <?php echo nice_date($buschedule['arrival'],"M d, D")." ".$buschedule['arrivaltime'] ; ?> <br>
                    <b> Dropping Point:</b> <?php foreach($passenger_info as $pinfo){foreach($allroutes as $route){if($route['id']==$pinfo['dropping']){echo $route['from'];}}}?>  (<?php echo $dtimes;?>)
				<br>
			<hr>
          ...
          <?php 
          $total = count($stotalpassenger) *$pinfo['rate'] - $pinfo['tdiscount'];
            }
            ?>
            <tr>
              <td colspan="5"><b> Seat(s):</b> <?php echo $seats;?></td>
            </tr>
            <tr>
              <th colspan="4"><p style="text-align:left;">Total<p/></th>
			...
			<tr>
				...
				<td colspan="2" style="border:none;">
					<p align="right">
					<img height="40px" src="<?php echo base_url(STATIC_IMG_DIR.'logo.png');?>"><br>
