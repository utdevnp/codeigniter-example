...
<div class="wrapper">
  <?php $this->load->view('hb/inc/adminheader');?>
  <?php $this->load->view('hb/inc/adminnavbar');?>
...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-6 col-xs-12">
		<?php $this->load->view('hb/inc/message');?>
		<?php $this->load->view('hb/inc/validation');?>
  ...
  <!-- /.content-wrapper -->
  <?php $this->load->view('hb/inc/adminfooter');?>
  <?php $this->load->view('hb/inc/admincontrolsidebar');?>
</div>
<!-- ./wrapper -->
