...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <div class="col-md-12">
      <ol class="breadcrumb breadcrumb-sm">
        ...
        <a href="<?php echo base_url('control/comitteesetup/add');?>" type="button" class="btn btn-success btn-xs btn-flat pull-right topbuttons"><i class="fa fa-plus"></i> Add New</a>
      </ol>
