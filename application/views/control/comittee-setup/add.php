      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->           
           <form method="POST" action="<?php echo base_url('control/comitteesetup/add');?>" enctype="multipart/form-data">     <div class="box-body">
                <div class="row">
                  <!--  content here -->
                  <div class="box-body">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="address" name="address" class="form-control" id="email" placeholder="Address">
                  </div>
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="register_no" class="form-control" id="totalbus" placeholder="Register No">
  		            ...
  		            <div class="form-group col-md-4">
  		              ...
  		              <input type="text" name="totalbus" class="form-control" id="totalbus" placeholder="Total Bus No">
  		            </div>
  		            <div class="form-group col-md-4">
