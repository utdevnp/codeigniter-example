        ...
        <div class="col-md-3">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $titleadd;?></h3>
                   ...
                   <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12 features">
                      <?php  foreach($all as $feat){
                        ?>
                          <input type="checkbox" name="features[]"  value="<?php echo $feat['id'];?>" /> <?php echo $feat['title'];?><br>
                          <?php
                        }
                      ?>                          
                  </div>
                        ...
                        <tr>
                          ...
                          <td>
                              <?php if($data['is_active']=='Y') { ?>
                                  <a href="<?php echo base_url('control/categorysetup/');;?>deactive/<?php echo $data['id'];?>"><strong><span class="label label-success">Yes</span> </strong></a>
                              <?php } else if($data['is_active']=='N') { ?>
                                 <a href="<?php echo base_url('control/categorysetup/');;?>active/<?php echo $data['id'];?>"><strong><span class="label label-danger">No</span> </strong></a>
                              <?php }?>
                          </td>
