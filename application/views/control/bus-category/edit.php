...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content">
      ...
      <form method="POST" action="<?php echo base_url('control/categorysetup/update/'.$this->uri->segment(4));?>">
        <div class="col-md-9">
          <div class="box">
                ...
                <div class="row">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-4">
                      ...
                      <input type="text" name="title" class="form-control" value="<?php echo $data['title'];?>" id="category" placeholder=" Bus Category">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="companyname">code</label>
                      <input type="text" name="code" class="form-control" value="<?php echo $data['code'];?>" id="companyname" placeholder=" Code">
                    </div>
                    <div class="form-group col-md-4">
                    <label>Active</label>
                    <?php 
      ...
      <div class="col-md-3">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo "features";?></h3>
              <?php $this->load->view('control/inc/message');?>
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
            ...
            <!-- /.box-header -->
              ...
              <div class="box-body">
                <div class="row">
                  <!--  content here -->
                  <div class="box-body">
                  <div class="form-group col-md-12 features">
                      <?php
                       $selected = explode(',',$data['features']);
                       foreach($all as $feat){
                        ?>
                          <input type="checkbox"  name="features[]" <?php echo in_array($feat['id'], $selected) ?  "checked" : "unchecked";?> value="<?php echo $feat['id'];?>" /> <?php echo $feat['title'];?> <br>
                          <?php
                        }
                      ?>                          
                  </div>
