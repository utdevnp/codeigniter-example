...
<div class="content-wrapper" style="min-height: 0px;">
    ...
    <ol class="breadcrumb breadcrumb-sm">
     ...
     <section class="content">
      ...
      <div class="row">
      <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('control/offersetup/add');?>">
        <div class="col-md-12">
          <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="offer_from" value="<?php echo date('Y-m-d');?>"  class="form-control pull-right datepickerdest " id="reservationtime">
                  </div>
                </div>
                 ...
                 <div class="form-group col-md-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="offer_to" value="<?php  echo date('Y-m-d',strtotime("+15 day"));?>"  class="form-control pull-right datepicker" id="reservationtime">
                  </div>
                </div>
                ...
                <label>Discount</label>
                  ...
                  <div class="input-group">
                   <input type="number"  ng-model="b" name="offer_discount" value="0"   class="form-control">
