...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content-header mainheadig">
      ...
      <!-- Add form for offer setup -->
      <?php // $this->load->view('control/offer-setup/add');?>
    </section>
    <div class="col-md-12">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td> <?php echo $data['offer_title']; ?></td> 
                           <td> <?php echo $data['offer_from'];  ?></td> 
                          <td> <?php echo $data['offer_to'];  ?></td> 
                         <td> <?php echo  $data['offer_discount'];?> % </td> 
                          <td><?php echo $data['coupon'];?> </td>
                          <td>
                              <?php if($data['is_active']=='Y') { ?>
                                  <a href="<?php echo base_url('control/offersetup/');;?>deactive/<?php echo $data['id'];?>"><strong><span class="label label-success">Yes</span> </strong></a>
                              <?php } else if($data['is_active']=='N') { ?>
                                 <a href="<?php echo base_url('control/offersetup/');;?>active/<?php echo $data['id'];?>"><strong><span class="label label-danger">No</span> </strong></a>
                              <?php }?>
                          </td>
