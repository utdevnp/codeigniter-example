                        ...
                        <tr>
                          ...
                          <td>
                              <?php if($data['is_active']=='Y') { ?>
                                  <a href="<?php echo base_url('control/complains/');;?>deactive/<?php echo $data['id'];?>"><strong><span class="label label-success">Open</span> </strong></a>
                              <?php } else if($data['is_active']=='N') { ?>
                                 <a href="<?php echo base_url('control/complains/');;?>active/<?php echo $data['id'];?>"><strong><span class="label label-danger">Close</span> </strong></a>
                              <?php }?>
                          </td>
