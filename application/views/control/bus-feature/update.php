          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="post" class="formvalidatoniForm" action="<?php echo base_url('control/featuresetup/update/'.$this->uri->segment(4));?>">
                <div class="box-body">
                <?php foreach($row as $data){ ?>
                <div class="form-group col-md-4">
                  <label for="company">Title</label>
                  <input type="text" value="<?php echo $data['title'];?>" class="form-control" name="title" id="title" placeholder="Feature Title">
                </div>
                <div class="form-group col-md-4">
                  <label for="companyname">Key</label>
                  <input type="text" value="<?php echo $data['key'];?>" class="form-control" id="key" name="key" placeholder="Feature Key">
                </div>
                <div class="form-group col-md-4">
                    <label>Active</label>
                       <?php 
