...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content">
      ...
      <form method="POST" action="<?php echo base_url('control/rootsetup/update/'.$this->uri->segment(4));?>">
        <div class="col-md-12">
              ...
              <div class="box-body">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-4">
                      ...
                      <input type="text" name="from" value="<?php echo $data['from'];?>" class="form-control" id="from" placeholder=" Boarding point">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="to">Code</label>
                      <input type="text" name="to"  value="<?php echo $data['to'];?>" class="form-control" id="to" placeholder=" Destination point">
                    </div>
                    <div class="form-group col-md-4">
                    <label>Active</label>
                    <?php 
