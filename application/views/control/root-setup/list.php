...
<div class="content-wrapper" style="min-height: 916px;">
    ...
    <section class="content">
      <div class="row">
        <form method="POST" action="<?php echo base_url('control/rootsetup/add');?>">
        <div class="col-md-3">
          <div class="box">
                ...
                <div class="row">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-12">
                      <label for="from">Places</label>
                      <input type="text" name="from" class="form-control" id="from" placeholder=" Boarding point">
                    </div>
                    <div class="form-group col-md-12">
                      <label for="to">Code</label>
                      <input type="text" name="to" class="form-control" id="to" placeholder=" Destination point">
                    </div>
                    <div class="form-group col-md-12">
                    <label>Active</label>
                    <?php 
                            ...
                            <tr>
                              ...
                              <td>
                                  <?php if($data['is_active']=='Y') { ?>
                                      <a href="<?php echo base_url('control/rootsetup/');;?>deactive/<?php echo $data['id'];?>"><strong><span class="label label-success">Yes</span> </strong></a>
                                  <?php } else if($data['is_active']=='N') { ?>
                                     <a href="<?php echo base_url('control/rootsetup/');;?>active/<?php echo $data['id'];?>"><strong><span class="label label-danger">No</span> </strong></a>
                                  <?php }?>
                              </td>
