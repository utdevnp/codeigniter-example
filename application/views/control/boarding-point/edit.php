...
<div class="content-wrapper" style="min-height: 916px;">
   ...
   <section class="content-header mainheadig">
    ...
    <section class="content">
      ...
      <div class="row">
      <form method="POST" action="<?php echo base_url('control/boardingsetup/update/'.$this->uri->segment(4));?>">
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
              ...
              <?php foreach($rows as $data){?>
                <div class="row">
                  ...
                  <label>Destirct</label>
                  <select name="destrict" class="form-control">
                    <option value="0">Select Destirct</option>
                    <?php foreach($busrot as $rot){?>
                      <option value="<?php echo $rot['id'];?>" <?php if($data['destrict']==$rot['id']){echo 'selected';}?>><?php echo $rot['from'];?><?php if($data['destrict']==$rot['id']){echo '*';}?></option>
                    <?php } ?>
                  </select>
                </div>
                    ...
                    <?php 
                     ...
                     <div class="form-group col-md-12">
                      <label for="companyname">Boarding Point</label>
                      <textarea type="text" name="title" class="form-control" id="category" placeholder=" Boarding Point"><?php echo $data['title'];?></textarea>
                    </div>
