            ...
            <!-- /.box-header -->
                ...
                <div class="row">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-12">
                      <label for="companyname">Page Title</label>
              ...
              <div class="box-footer">
                <div class="row">
                  <!-- // buttons -->
                  <div class="form-group col-md-4">
                    <button type="submit" name="submit" value="addpage" class="btn btn-success btn-sm btn-flat"><i class="fa fa-floppy-o"></i> Save </button>
