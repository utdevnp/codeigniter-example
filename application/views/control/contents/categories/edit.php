...
<div class="content-wrapper" style="min-height: 916px;">
   ...
   <section class="content-header mainheadig">
    ...
    <section class="content">
      ...
      <div class="row">
      <form method="POST" action="<?php echo base_url('control/content/update');?>">
        <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="box-body">
                   ...
                   <div class="form-group col-md-12">
                      <label for="companyname">Category Title</label>
                      <input type="text" name="title" value="<?php echo $cat['title']; ?>" class="form-control" id="category" placeholder=" Bus Category">
                    </div>
                    <div class="form-group col-md-12">
                      <label for="companyname">Detail</label>
                      <div class="clearfix"></div>
                      <textarea class="terms" name="detail" placeholder="Terms And Policy" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $cat['content'];?></textarea>
                    </div>
              ...
              <div class="box-footer">
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <button type="submit" name="submit" value="editcat" class="btn btn-success btn-sm btn-flat"><i class="fa fa-floppy-o"></i> Save </button>
