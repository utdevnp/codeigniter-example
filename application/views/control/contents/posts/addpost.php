...
<div class="content-wrapper" style="min-height: 916px;">
   ...
   <section class="content-header mainheadig">
    ...
    <section class="content">
      ...
      <div class="row">
      <form method="POST" action="<?php echo base_url('control/content/add');?>" enctype="multipart/form-data">
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
              ...
              <div class="box-footer">
                <div class="row">
                  <!-- // buttons -->
                  <div class="form-group col-md-4">
                    <button type="submit" name="submit" value="addpost" class="btn btn-success btn-sm btn-flat"><i class="fa fa-floppy-o"></i> Save </button>
