              ...
              <div class="box-tools pull-right">
               <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo ADMIN_BASE.'busscheadual';?>">Departing Buses</a></li>
                  </ul>
                </div>
                        ...
                        <tr>
                          ...
                          <td>
                              <?php if($data['is_active']=='Y') { ?>
                                  <a href="<?php echo base_url('control/busscheadual/');;?>deactive/<?php echo $data['id'];?>"><strong><span class="label label-success disabled">Opened</span> </strong></a>
                              <?php } else if($data['is_active']=='N') { ?>
                                 <a href="<?php echo base_url('control/busscheadual/');;?>active/<?php echo $data['id'];?>"><strong><span class="label label-danger disabled">Closed</span> </strong></a>
                              <?php }?>
                          </td>
