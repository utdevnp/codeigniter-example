<!DOCTYPE html>
<!-- saved from url=(0036)data:text/html,chromewebdata#buttons -->
...
<body id="t" i18n-values=".style.fontFamily:fontfamily;.style.fontSize:fontsize" jstcache="0" class="neterror" style="font-family: &quot;Segoe UI&quot;, Tahoma, sans-serif; font-size: 75%;">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="16"><?php echo $_SERVER['SERVER_NAME'];?></strong>’s server <abbr jsvalues="title:dnsDefinition" jstcache="17" title="DNS is the network service that translates a website’s name to its Internet address.">DNS address</abbr> could not be found.</p>
        <div id="suggestions-list" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="6">
          ...
          <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? &#39;single-suggestion&#39; : &#39;&#39;" jstcache="14" class="">
            <li jsselect="" jsvalues=".innerHTML:summary" jstcache="15" jsinstance="0">Checking the connection</li><li jsselect="suggestionsSummaryList" ><a onclick="toggleHelpBox()" jstcache="0">Checking the proxy, firewall, and DNS configuration</a></li><li jsselect="suggestionsSummaryList"><a href="open:NetworkDiagnosticsDA" id="diagnose-link" jstcache="0">Running Windows Network Diagnostics</a></li>
          </ul>
        </div>
    ...
    <div id="details" class="" jstcache="0">
      <div class="suggestions" jsselect="suggestionsDetails" jstcache="4" jsinstance="0">
        <div class="suggestion-header" " jstcache="11">Check your Internet connection</div>
        <div class="suggestion-body"  jstcache="12">Check any cables and reboot any routers, modems, or other network
    devices you may be using.</div>
        ...
        <div class="suggestion-body" jsvalues=".innerHTML:body" jstcache="12">Go to
          the Chrome menu &gt;
          <span jscontent="settingsTitle" jstcache="18">Settings</span>
          &gt;
          <span jscontent="advancedTitle" jstcache="19">Show advanced settings…</span>
          and deselect "<span jscontent="noNetworkPredictionTitle" jstcache="20">Use a prediction service to load pages more quickly</span>."
      ...
      Go to
          ...
          <span jscontent="advancedTitle" jstcache="19">Show advanced settings…</span>
          &gt;
          <span jscontent="proxyTitle" jstcache="21">Change proxy settings…</span>
          &gt;
          LAN Settings
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="16">dkfgjsdkjg.com</strong>’s server <abbr jsvalues="title:dnsDefinition" jstcache="17" title="DNS is the network service that translates a website’s name to its Internet address.">DNS address</abbr> could not be found.</div>
  </div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"Details","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"dkfgjsdkjg.com","msg":"This site can’t be reached"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadTrackingId":-1,"reloadUrl":"http://dkfgjsdkjg.com/"},"suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\">Try running Windows Network Diagnostics\u003C/a>."}],"summary":{"dnsDefinition":"DNS is the network service that translates a website’s name to its Internet address.","failedUrl":"http://dkfgjsdkjg.com/","hostName":"dkfgjsdkjg.com","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong>’s \u003Cabbr id=\"dnsDefinition\">DNS address\u003C/abbr> could not be found. Diagnosing the problem."},"textdirection":"ltr","title":"dkfgjsdkjg.com"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
